<?php
    ...
    class MysqlAdapter {
        ...
        public function connect() {
             ...
             * to assure that there's only one connection instance 
             */
            // Connect only once
            if ($this->_link === null) {
        ...
        public function query ($query) {
            ...
            // ("Lazy Load") Connect to MySQL (Connect only when executing something on the DB)
            $this->connect();
        ...
        public function quoteValue($value) {
            ...
            // mysqli_real_escape_string() doesn't work without connection
            $this->connect();
            if ($value === null) {
                $value = 'NULL';
            }
